...
extern void lcd_out_dat(const unsigned char dat, 
	const unsigned char nctrl);
extern void lcd_out_ctl(const unsigned char cmd, 
	const unsigned char nctrl);
extern void lcd_fill(const unsigned char pattern);
extern void lcd_erase(void);
extern void lcd_update(const unsigned char top, 
	const unsigned char bottom);
extern void lcd_update_all(void);

void lcd_dot(const unsigned char x, const unsigned char y, 
...
extern void lcd_line( uint8_t x1, uint8_t y1, 
	uint8_t x2, uint8_t y2, const uint8_t mode );
extern void lcd_rect( const uint8_t x, const uint8_t y, 
	uint8_t width, uint8_t height, const uint8_t mode);
extern void lcd_box(const uint8_t x, const uint8_t y, 
	uint8_t width, const uint8_t height, const uint8_t mode);
extern void lcd_circle(const uint8_t xCenter, const uint8_t yCenter, 
	const uint8_t radius, const uint8_t mode);

extern void lcd_glyph(uint8_t left, uint8_t top,
...
extern void lcd_bitmap(const uint8_t left, const uint8_t top, 
	const struct IMG_DEF *img_ptr, const uint8_t mode);

#ifdef LCD_DEBUG
extern void lcd_test(const unsigned char pattern);
extern void lcd_raw(const unsigned char page,
