...
#define MMC_CD		(!(PINE & 0x40))	/* Card detected.   yes:true, no:false, default:true */
#define MMC_WP		(PINE & 0x80)		/* Write protected. yes:true, no:false, default:false */
...
void power_off (void)
{
	...
	DDRB  &= ~0b11111111;	/* Set SCK/MOSI/CS as hi-z, INS#/WP as pull-up */
	PORTB &= ~0b11111111;
